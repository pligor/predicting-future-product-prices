...
class PriceHistoryMobAttrs26DataProvider(CrossValDataProvider):  # , SubSampleableDataProvider):
    ...
    def __init__(self,
        ...
        inputs, mobile_attrs, targets = dic['inputs'], dic['mobile_attrs'], dic['targets']
        ...
        #this hardcoding here might not be the best. we have self.datalist as a way to access them
        #self.inputs = inputs
        ...
        super(PriceHistoryMobAttrs26DataProvider, self).__init__(
            datalist=[inputs, mobile_attrs, targets],
    ...
    def next(self):
        ...
        """
        inputs_batch, mobile_attrs_batch, targets_batch = super(PriceHistoryMobAttrs26DataProvider, self).next()
        ...
        return inputs_batch, mobile_attrs_batch, final_targets
