...
class PriceHistoryMobAttrsDateDataProvider(CrossValDataProvider):  # , SubSampleableDataProvider):
    ...
    def __init__(self,
        ...
        inputs, mobile_attrs, targets, decoder_extra_inputs = dic['inputs'], dic['mobile_attrs'], dic['targets'], dic[
        ...
        super(PriceHistoryMobAttrsDateDataProvider, self).__init__(
            datalist=[inputs, mobile_attrs, targets, decoder_extra_inputs],
    ...
    def next(self):
        ...
        """
        inputs_batch, mobile_attrs_batch, targets_batch, decoder_extra_inputs_batch = super(
            PriceHistoryMobAttrsDateDataProvider, self).next()
        ...
        return inputs_batch, mobile_attrs_batch, final_targets, final_dec_extra_ins
    ...
    @property
    def targets(self):
        return self.datalist[self.DATALIST_TARGETS_IND]
