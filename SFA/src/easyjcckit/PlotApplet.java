 ...
 * as explained in {@link easyjcckit.util.FlatConfigData}. The <tt>PlotApplet</tt>
 ...
 *         constructor</a> of {@link easyjcckit.data.DataPlot}.</td></tr>
 * <tr><td><tt>data</tt></td>
  ...
  public void run() {
    try {
      ...
      canvas.setRenderer(config.get(RENDERER_KEY, 
                                    "easyjcckit.renderer.GraphicsRenderer"));
