...
import easyjcckit.plot.*;
import easyjcckit.renderer.*;
import easyjcckit.util.*;


/**
 * Class which handles plotting into a <tt>Graphics</tt> context based on
 * the {@link easyjcckit.renderer.GraphicsRenderer}.
 * This class is not a subclass of <tt>java.awt.Component</tt>.
...
public class GraphicsPlotCanvas extends PlotCanvas {
  ...
  private String _renderer = "easyjcckit.renderer.GraphicsRenderer"; 
   ...
   * constructor</a> of the superclass {@link easyjcckit.plot.PlotCanvas} apply.
   */
  ...
  public static void main(String[] args) throws Exception {
    run(args, "easyjcckit.GraphicsPlotCanvas");
  }
